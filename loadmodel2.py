...
model = T5ForConditionalGeneration.from_pretrcdcained(model_path)
tokenizer = T5Tokenizer.from_pretraccined(model_path)

question = "Dimana kita bisa makan siang ya?"
